...
b1 = Book.create(title: "The Wonderful Wizard of Oz", author: "L. Frank Baum", description: "Girl from Kansas swept to far away land by cyclone.", publisher: "George M. Hill Company", weeks_on_list: 5980, rank_this_week: 1)
Review.create(comment: "Best children's book of all time", author: "Patrick", book_id: b1.id)

b2 = Book.create(title: "Walden", author: "Henry David Thoreau", description: "Man lives in solitude for 2 years and summarizes the superfluities of modern life.", publisher: "self-published", weeks_on_list: 8372, rank_this_week: 2)
Review.create(comment: "Hard hitting critique of european ideals", author: "Patrick", book_id: b2.id)
